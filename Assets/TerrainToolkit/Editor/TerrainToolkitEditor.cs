                ...
                switch (terrain.generatorTypeInt) {
                    case 0:
                        ...
                        if (GUI.Button (buttonRect, "Generate Voronoi Features")) {
                            // Undo...
                            Terrain ter0 = (Terrain) terrain.GetComponent (typeof (Terrain));
                            if (ter0 == null) {
                                return;
                            }
                            TerrainData terData0 = ter0.terrainData;
                            Undo.RegisterUndo (terData0, "Terrain Generator");
                    ...
                    case 1:
                        ...
                        if (GUI.Button (buttonRect, "Generate Fractal Terrain")) {
                            ...
                            Undo.RegisterUndo (terData1, "Terrain Generator");
                            TerrainToolkit.GeneratorProgressDelegate generatorProgressDelegate = new TerrainToolkit.GeneratorProgressDelegate (updateGeneratorProgress);
                            terrain.generateTerrain (generatorProgressDelegate);
                            EditorUtility.ClearProgressBar ();
                            GUIUtility.ExitGUI ();
                    ...
                    case 2:
                        ...
                        if (GUI.Button (buttonRect, "Generate Perlin Terrain")) {
                            ...
                            TerrainData terData3 = ter3.terrainData;
                            Undo.RegisterUndo (terData3, "Terrain Generator");
                            TerrainToolkit.GeneratorProgressDelegate generatorProgressDelegate = new TerrainToolkit.GeneratorProgressDelegate (updateGeneratorProgress);
                            terrain.generateTerrain (generatorProgressDelegate);
                            EditorUtility.ClearProgressBar ();
                            GUIUtility.ExitGUI ();
                    ...
                    case 3:
                        ...
                        if (GUI.Button (buttonRect, "Smooth Terrain")) {
                            // Undo...
                            Terrain ter4 = (Terrain) terrain.GetComponent (typeof (Terrain));
                            if (ter4 == null) {
                                return;
                            }
                            TerrainData terData4 = ter4.terrainData;
                            Undo.RegisterUndo (terData4, "Smooth Terrain");
                            TerrainToolkit.GeneratorProgressDelegate generatorProgressDelegate = new TerrainToolkit.GeneratorProgressDelegate (updateGeneratorProgress);
                            terrain.generateTerrain (generatorProgressDelegate);
                            EditorUtility.ClearProgressBar ();
                            GUIUtility.ExitGUI ();
                    ...
                    case 4:
                        ...
                        if (GUI.Button (buttonRect, "Normalise Terrain")) {
                            // Undo...
                            Terrain ter5 = (Terrain) terrain.GetComponent (typeof (Terrain));
                            if (ter5 == null) {
                                return;
                            }
                            TerrainData terData5 = ter5.terrainData;
                            Undo.RegisterUndo (terData5, "Normalise Terrain");
                            TerrainToolkit.GeneratorProgressDelegate generatorProgressDelegate = new TerrainToolkit.GeneratorProgressDelegate (updateGeneratorProgress);
                            terrain.generateTerrain (generatorProgressDelegate);
                            EditorUtility.ClearProgressBar ();
                            GUIUtility.ExitGUI ();
